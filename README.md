...
- **Google Calendar** — conexão direta pelo navegador, só leitura, sem servidor e sem backend. Você cola o Client ID de um projeto seu do Google Cloud e escolhe a agenda; o app busca os eventos já expandidos e no fuso certo, numa janela de 14 dias. Atualiza sozinho ao abrir o app, ao voltar para ele e a cada 15 minutos. O token de acesso fica só na memória — nunca é gravado no aparelho.
